...
function ShopLoginForm() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: theme.primaryColor || '#f3f4f6' }}>
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          {theme.logoUrl && (
            <div className="flex justify-center mb-4">
              <img src={theme.logoUrl} alt={theme.name || 'Shop Logo'} className="h-12" />
            </div>
          )}
          <CardTitle className="text-2xl font-bold text-center">{theme.name || 'Shop Login'}</CardTitle>
